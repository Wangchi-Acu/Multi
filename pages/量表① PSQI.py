...
st.markdown("<h1 style='font-size: 36px; text-align: left;'>江苏省中医院针灸科</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='font-size: 30px; text-align: left;'>失眠专病门诊</h1>", unsafe_allow_html=True)
